...
AND {$DB->tablePrefix}exam_result.id=<bind>$exam_result_id</bind>
WHERE  {$DB->tablePrefix}exam_result.block_user_id='$block_user_id' ",true);

if(!isset($exam->id))
	exit("خطا: برگه  سوال متعلق به شما یافت نشد");
