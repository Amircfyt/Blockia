...
if(isset($exam_result->id))
{
	...
	if($result)
	{
		...
		header("location:exam_resultPage2.php?exam_id=".$Encryption->encode($exam_result->exam_id));
		exit;
	}
	else
	{
...
{
	$Msg->error("اطلاعات مورد نظر یافت نشد");
	header("location:exam_resultPage2.php");
	exit;
}
